...
public class Chomp extends JFrame
{
  ...
  public Chomp()
  {
    ...
    HumanPlayer human = new HumanPlayer(this, game, board, "Mike");
    HumanPlayer human1 = new HumanPlayer(this, game, board, "Stephen");
    ...
    display.setText(" You go first, " + human.getName() + " ...");
