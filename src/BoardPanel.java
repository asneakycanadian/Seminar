...
{
  //private final int ROWS = 15, COLS = 15;   // board dimensions
  ...
  public BoardPanel()
  {
    ...
    //setPreferredSize(new Dimension(COLS * BoardPanel.HEIGHT, ROWS * BoardPanel.WIDTH));
  ...
  public Location getPos(int x, int y)
  {
    ...
    return new Location(y / cellHeight, x / cellWidth);
    ...
    for (int r = 0; r < ROWS; r++)
    {
      for (int c = 0; c < COLS; c++)
      {
        ...
        if (r == 0 && c == 0)
        {
          ...
          g.drawLine(x+3, y + cellHeight - 6, x + cellWidth - 6, y+3);
        }
      }
    }
